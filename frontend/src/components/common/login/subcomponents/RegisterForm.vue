  ...
  <div v-if="!otpData">
    ...
    <form @submit.prevent="submit" class="flex flex-col gap-2 mb-4">
      ...
      <div>
        ...
        />
        <p v-if="errors.phoneNumber" class="mt-1 text-[11px] text-red-500">
          {{ errors.phoneNumber }}
        </p>
      </div>
      ...
      <div>
        ...
        <div class="flex gap-3 mt-1.5">
          <button
            ...
            :key="option.value"
            type="button"
            @click="selectGender(option.value as 'male' | 'female')"
            :class="[
      ...
      <div>
        ...
        <p v-if="errors.dateOfBirth" class="mt-1 text-[11px] text-red-500">
          {{ errors.dateOfBirth }}
        </p>
      </div>
      ...
      <div>
        ...
        <p v-if="errors.confirmPassword" class="mt-1 text-[11px] text-red-500">
          {{ errors.confirmPassword }}
        </p>
      </div>
